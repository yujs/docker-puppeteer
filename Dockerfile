...
# 解决打包报错：The following signatures couldn't be verified because the public key is not available: NO_PUBKEY 4EB27DB2A3B88B8B
RUN apt-key adv --recv-keys --keyserver keyserver.ubuntu.com 4EB27DB2A3B88B8B
